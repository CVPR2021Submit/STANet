...
import random
from SAcoarse_model import att_Model
...
from SAcoarse_data import ImageFolder
...
parser.add_argument('--dir_order_train', type=str,
                    default='F:\\wgt\\AVE\\AVE_Dataset\\Forg\\',
...
def main(args):
    ...
    train_loader = DataLoaderX(train_data, args.batch_size, shuffle=True, num_workers=4)
    epoch_l = []
